...
?>
<div class="flex justify-between items-center mb-6 sm:mb-8"><div><h1 class="text-2xl sm:text-3xl font-black text-slate-900">Usuarios</h1><p class="text-sm text-slate-600">Cuentas y roles de acceso</p></div></div>
...
<section class="bg-white border rounded-2xl p-4 sm:p-6 mb-7 shadow-sm"><h2 class="font-black text-lg mb-4">Crear cuenta</h2>
<form method="post" class="grid sm:grid-cols-2 xl:grid-cols-5 gap-4 items-end"><input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars(csrfToken()); ?>"><input type="hidden" name="action" value="create">
